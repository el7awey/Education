  ...
  const createPayment = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Open payment URL in new window for security
        ...
        if (!paymentWindow) {
          throw new Error(isRTL ? 'فشل في فتح نافذة الدفع' : 'Failed to open payment window');
        }
        ...
        toast({
          ...
          description: isRTL ? 'ستفتح نافذة الدفع في تبويب جديد' : 'Payment window will open in a new tab'
        });
